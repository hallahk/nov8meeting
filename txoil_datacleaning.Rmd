...
txIP <- txIP %>% 
  dplyr::select(c(IPAddress, ResponseId, gender, female, age, age_levels, education, race, race_cat, Q6, employment, county, NAME, location, quota, metro_uic, health_status, k6sums, mental_illness, threat_sum, feltimpact_sum, solastalgia_sum, geometry))
```
